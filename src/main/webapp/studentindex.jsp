					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							<li class="nav-item active">
								<a class="nav-link" href="studentindex.jsp">Home <span class="sr-only">(current)</span></a>
							</li>
							<!-- <li class="nav-item @@about-active">
								<a class="nav-link" href="about.jsp">About</a>
							</li> -->
							<li class="nav-item @@contact-active">
								<a class="nav-link" href="studentprofile.jsp">YOUR PROFILE</a>
							</li>
          ...
          <div class="col-md-6">
            <div class="feature-16-gd">
              ...
              <div class="feature-16-gd-info">
                ...
                <a href="services.jsp" class="btn btn-primary theme-button mt-4">Learn more</a>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="middle-section">
        ...
        <div class="link-list-menu">
            ...
            <a href="about.jsp" class="btn btn-outline-light btn-more">About Us</a>
        </div>
      </div>
    </div>
  </div>
