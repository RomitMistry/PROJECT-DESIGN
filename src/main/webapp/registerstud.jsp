...
<section class="w3l-skill-breadcrum">
  <div class="breadcrum">
    <div class="container">
      <p><a href="index.jsp">Home</a> &nbsp; / &nbsp; Student Registration</p>
    </div>
  </div>
</section>
<!-- //breadcrum -->
		...
		<div class="contacts12-main py-md-3">
			...
			<form action="Studentcontroller" method="post">
				<div class="main-input">
					...
					<input type="password" name="password" placeholder="Enter Password" class="contact-input" required="" />
				</div>
           ...
           <div class="col-lg-2 col-md-6 footer-list-29 footer-4 mt-5">
            <h6 class="footer-title-29">Quick Links</h6>
             <ul>
               ...
               <li><a href="registerstud.jsp">Contact</a></li>
             </ul>
           </div>
         </div>
       </div>
