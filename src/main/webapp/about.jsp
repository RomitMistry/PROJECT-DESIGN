		...
		<div class="hero-header-11-content">
			<div class="container">
				<nav class="navbar navbar-expand-lg navbar-light py-md-2 py-0 px-0">
					<a class="navbar-brand" href="index.jsp"><img src="assets/images/logo-icon.png" alt="" />Skill</a>
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						<ul class="navbar-nav ml-auto">
							...
							<li class="nav-item @@services-active">
								<a class="nav-link" href="studentlog.jsp">LOGIN</a>
							</li>
							<li class="nav-item @@contact-active">
								<a class="nav-link" href="registerstud.jsp">Registration</a>
							</li>
						</ul>
					</div>
				</nav>
        ...
        <div class="col-lg-6 cwp23-text">
          ...
          <div class="cwp23-text-cols">
            <div class="column">
              ...
              <a href="services.jsp">Group Seminars</a>
              <p>consectetur adipisicing elit, sed do eiusmod tempor </p>
            </div>
            <div class="column">
              <span class="fa fa-graduation-cap" aria-hidden="true"></span>
              <a href="services.jsp">Trending Courses</a>
              <p>consectetur adipisicing elit, sed do eiusmod tempor </p>
            </div>
            <div class="column">
              <span class="fa fa-history" aria-hidden="true"></span>
              <a href="services.jsp">Large Library</a>
              <p>consectetur adipisicing elit, sed do eiusmod tempor </p>
            </div>
            <div class="column">
              <span class="fa fa-users" aria-hidden="true"></span>
              <a href="services.jsp">Expert Teachers</a>
              <p>consectetur adipisicing elit, sed do eiusmod tempor </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="middle-section text-center">
          <div class="section-width mb-5">
            ...
            <a href="registerstud.jsp" class="btn btn-light theme-button py-2 px-5">Contact Us</a>
          </div>
        </div>
      </div>
    </div>
...
<!-- //team -->
 <section class="w3l-quote py-5">
    <div class="container py-lg-3">
      ...
      <a href="registerstud.jsp" class="btn btn-secondary theme-button">Become a Teacher</a>
           ...
           <div class="col-lg-2 col-md-6 footer-list-29 footer-2 mt-5">
            <h6 class="footer-title-29">Explore More</h6>
             <ul>
               ...
               <li><a href="registerstud.jsp">Buy Course Online</a></li>
             </ul>
           </div>
           ...
           <div class="col-lg-2 col-md-6 footer-list-29 footer-4 mt-5">
            <h6 class="footer-title-29">Quick Links</h6>
             <ul>
               ...
               <li><a href="registerstud.jsp">Registration</a></li>
             </ul>
           </div>
         </div>
       </div>
